...
The spatial residual map is computed with the multiple regression technique. It explains the magnitude of residuals (i.e. how large they are) using the X and Y spatial coordinates.   
