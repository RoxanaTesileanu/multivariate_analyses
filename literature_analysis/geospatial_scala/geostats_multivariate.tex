...
MANOVA residuals are plotted on the X-Y plane of the spatial coordinates in a spatial residual plot indicating their magnitude (i.e. dimensions). On this plot areas of high clumped residuals are delineated.  
Within these areas of local variation the MANOVA residuals are investigated with the multiple regression technique. This will explain the magnitude of residuals (i.e. how large they are) using the X and Y spatial coordinates in which the data are given.
\\
\\
