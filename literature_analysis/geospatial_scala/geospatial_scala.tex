...
Every probability distribution is characterized using its location, spread and shape \cite{isaaks_applied_1989}. Measures of location aim at finding the center of the distribution and the commonly used one are the mean, median and mode. Measures of spread aim at describing how much a variable varies over its range of values and include variance, standard deviation, interquartile range.      
