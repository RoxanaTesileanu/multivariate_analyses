...
\\
UNIFORM DISTRIBUTION \\
The Uniform distribution is the simplest probability distribution. It implies the same probability for the entire range, [a,b] of a random variable X \cite{lial_calculus_2012} \cite{pfeffer_practical_2016}.
