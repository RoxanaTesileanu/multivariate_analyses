...
\subsection {Implementing the gradient k-improvement optimization of the neighborhood size and direction}

\section {Variable-based multivariate analyses}

\subsection{Implementing the multiple regression analysis}

\subsection {Implementing MANOVA}

\subsection {Vizualizing spatial residual maps}
