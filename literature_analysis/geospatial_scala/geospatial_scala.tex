...
In order to start building the multivariate statistical models, a library is required which offers computing solutions for solving systems of simulataneous equations (for multiple linear regression models), QR or SVD decomposition of statistical matrices (for MANOVA). 
