...
For a bivariate Normal distribution, with $x_i$ expressed as $\textbf{x_i}= (x_1, x_2)$, the mean is expressed as a vector $\textbf{\mu}= (\mu_1, \mu_2)$ and the variance becomes a variance-covariance matrix $\textbf{\sum}$.    
\\
\\
BETA DISTRIBUTION\\
