...
We can thus say that between $\mu - \sigma$ and $\mu + \sigma$, i.e. between $-\sigma$ and $+\sigma$  of a standard Normal curve (because $\mu=0$), we have $0.8413 - 0.1589=0.6826$ of area, i.e. probability. Or, in other words, 68.26\% of the observations are between $$ \cite{pelz}.  
