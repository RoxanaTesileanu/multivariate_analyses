...
The $x_i$ values of any Normal distribution are coverted to $z_i$-scores, i.e. the $x_i$ values of a z distribution, using the following relationship:
\tab
\begin{equation*}
z_i = \frac{x_i- \mu}{\sigma}
\end{equation*} 
The probability value to the left of any number $x_i$ corresponds to the probability value to the left of its associated $z_i$ score \cite{lial_calculus_2012}.
