...
Because there is an infinite number of possible Normal distributions which might be used, calculating probability values from all these curves would imply too much computational effort each time an analysis is done, thus computer programs use the standard Normal distribution (z distribution) when performing calculations.     
