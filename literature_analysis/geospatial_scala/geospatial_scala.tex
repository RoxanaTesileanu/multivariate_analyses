...
There are several ways to obtain a permutation matrix P: partial pivoting (used by dgesv \cite{anderson_lapack_1999}), complete pivoting, and rook pivoting \cite{golub_matrix_2013}. Partial pivoting involves swapping of rows, complete pivoting involves swapping rows and column and   
