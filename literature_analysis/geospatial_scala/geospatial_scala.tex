...
A dataset can be represented as a data matrix \textit{A} with m rows (each observation being represented by a row) and n columns (each recorded variable being represented by a column). 
Thus the data matrix \textit{A} contains m observations, where $m=1,..,i$, and n variables, where $n=1,..,j$.
