...
For a bivariate Normal distribution, with \textbf{x\textsubscript{i}} expressed as \textbf{x\textsubscript{i}}= $(x_1, x_2)$, the mean is expressed as a nx1 matrix $\textbf{\mu}=[\mu_1, \mu_2]'$ \footnote{The nx1 matrix has the form of a column vector.}
