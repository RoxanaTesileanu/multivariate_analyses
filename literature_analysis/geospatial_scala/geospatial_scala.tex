...
\end{equation} 
Thus, it is a function which depends on the number of dimensions (k), the vector of variable means ($\boldsymbol{\mu}$) and the variance-covariance matrix ($\boldsymbol{\Sigma}$).
