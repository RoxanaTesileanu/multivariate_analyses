...
\\
\\
\textbf{Every probability distribution is characterized using its location, spread and shape} \cite{isaaks_applied_1989} \cite{webster_geostatistics_2007}.
...
For recalling these measures their formulae are provided below.
 For a random continuous variable X with values x from 1 to i within its range, the interval [a,b], and having a probability distribution p(x):
\\
\\
