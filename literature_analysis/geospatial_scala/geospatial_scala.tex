...
\end{equation*}
Now, that the origins of $\mu$ and $\sigma$, the two parameters of every Normal distribution, are clear, we can see that there are infinitely many possible combinations of mean and variance, thus an infinite number of possible Normal distributions \cite{}.  
