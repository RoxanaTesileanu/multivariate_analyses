...
for (p <- pointsHP1) { multiPointHP1.AddGeometry(multiPointPoint.AddPoint(p.\underline{\space}1, p.\underline{\space}2) } \\
pointsRoad1\\
...
\\
\\
Next, we will return to vector layers. In the following code snippet we will create a vector layer called Roads,using the multiline geometry created in code snippet 4.
