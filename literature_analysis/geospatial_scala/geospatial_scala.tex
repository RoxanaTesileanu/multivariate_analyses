...
If for a univariate Normal distribution, each observation $x_i$ can be represented as a one-dimensional vector containing one recorded variable, for bi- and multivariate Normal distributions the individual observations $x_i$ can be represented as two- or multidimensional vectors containing two or more recorded variables. For a bivariate Normal distribution, with $x_i$ expressed as $\textbf{x_i}= (x_1, x_2)$  
\\
\\
BETA DISTRIBUTION\\
