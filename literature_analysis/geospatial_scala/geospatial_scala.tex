...
For a bivariate Normal distribution, with $x_i$ expressed as \textbf{$x_i$}= $(x_1, x_2)$, the mean is expressed as a nx1 matrix \textbf{$\mu$}= $left[\mu_1, \mu_2 right]$ and the variance becomes a variance-covariance matrix \textbf{$\Sigma$}.    
\\
\\
BETA DISTRIBUTION\\
