...
\\
\\
Using the above code a linear system of type $Ax=b$ was solved using LAPACK dgesv, and, at the same time I've made use of Scala types and also the output was represented as a Scala type. This is an important aspect in further development steps.  
