...
The univariate Normal distribution can be extended by adding more dimensions to and observation $x_i$. If for a univariate Normal distribution, each ovservation $x_i$ can a vector containing one dimension, for bi- and multivariate Normal distributions  The bivariate Normal distribution   
\\
\\
BETA DISTRIBUTION\\
