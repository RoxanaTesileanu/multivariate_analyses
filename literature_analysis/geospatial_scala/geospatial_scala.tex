...
You can see now that a new subdirectory appeared in your Scala porject's directory called rdgps which contains the shapefile (a .dbf file, a .prj file, a .shp file and a .shx file).
