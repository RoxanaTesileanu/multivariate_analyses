...
\\    
BETA DISTRIBUTION\\
Not just the Normal distribution can be used to characterize the distribution of the residuals from the fitted models \cite{quinn_experimental_2002} \cite{pfeffer_practical_2016}. Errors can follow a binomial distribution like in the assumptions of the logistic regression, or a Poisson distribution like in the assumptions of the Poisson regression \cite{quinn_experimental_2002}. The Beta distribution is commonly used as a prior probability distribution for binary variables in Bayesian analyses (e.g. within the beta-binomial model \cite{jackman_bayesian_2009}, \cite{pfeffer_practical_2016}) \cite{quinn_experimental_2002}.  
