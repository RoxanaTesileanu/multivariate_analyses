...
Each observation is represented by a row vector \textbf{m\textsubscript{i}} and each variable is represented by a column vector \textbf{n\textsubscript{j}}.  
 Each entry in \textit{A}, $a_{ij}$, represents the recorded value for the $i^{th}$ observation \textbf{m\textsubscript{i}} on the $j^{th}$ recorded variable \textbf{n\textsubscript{j}}.
