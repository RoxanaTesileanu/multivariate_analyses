...
It implies the same probability for the entire range, [a,b], of a random continuous variable X and is used to express the fact that no value of X is believed to be more possible than the other values of X \cite{jackman_bayesian_2009} \cite{lial_calculus_2012} \cite{pfeffer_practical_2016}:
\tab
\begin{equation}
 p(x)= 
\begin{cases}
