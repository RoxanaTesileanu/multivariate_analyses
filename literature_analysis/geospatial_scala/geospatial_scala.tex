...
From the previous subsection, it is known that integrating over the range of values of the continuous random variable X using a probability density function is 1. 
