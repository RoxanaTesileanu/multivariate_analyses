...
Google Earth uses WGS84 with geographic coordinates (lat/lon), unprojected, with EPSG code 4326 (\href{https://gis.stackexchange.com}{https://gis.stackexchange.com}) (see the first SRS example at page 7, section 2.3.1). 
\\
\\
