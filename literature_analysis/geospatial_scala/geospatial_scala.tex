...
We conventionally write the fact that a random variable X has a Normal density with mean $E(x)=\mu$ and variance $V(x)=\sigma^2$ as $x\sim N(\mu, \sigma^2)$ \cite{jackman_bayesian_2009}.
