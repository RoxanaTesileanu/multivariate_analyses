...
\\
In this code I will use the ETRS1989/LAEA and the Pulkovo1942(58)/ Stereo70 SRSs. The first one is the SRS for all Europe and it is used for statistical mapping at all scales and other purposes where true area representation is required (\href{http://spatialreference.org/ref/epsg/3035/}{http://spatialreference.org/ref/epsg/3035/}), the later SRS is for Romania and is used in large and medium scale topographic mapping and engineering surveys (\href{http://spatialreference.org/ref/epsg/3844/}{http://spatialreference.org/ref/epsg/3844/}).  
\\
...
PROJCS["Pulkovo 1942(58) / Stereo70",\\
    ...
    PROJECTION["Oblique Stereographic",\\
        AUTHORITY["EPSG","9809"]],\\
    PARAMETER["central\underline{\space}meridian",25.0],\\
    PARAMETER["latitude\underline{\space}of\underline{\space}origin",46.0],\\
    PARAMETER["scale\underline{\space}factor",0.99975],\\
  PAR...\\
\\
