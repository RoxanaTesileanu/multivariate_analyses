...
Table 2 represents a discrete probability function because it has a finite domain (class 1 to class 8 represent a discrete variable). Probability functions with an infinite domain within some real number interval (values like 43.25 cm DBH are possible and represent a continuous variable) are called continuous probability distributions.  
