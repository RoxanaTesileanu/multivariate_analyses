...
\\
\\ 
 If prior information helps in distinuishing between response and predictor variables, then the dataset can be splitted in two or more subsets and perform supervised statistical analyses based on this dataset partitioning.
 If no prior information is available, and no clear partitioning of the dataset is possible, unsupervised statistical analyses are performed \cite{carroll_mathematical_1997}.  
