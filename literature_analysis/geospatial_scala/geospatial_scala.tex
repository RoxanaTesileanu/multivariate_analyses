...
and the variance V(x) becomes a variance-covariance matrix $\boldsymbol{\Sigma}$ \cite{jackman_bayesian_2009} \cite{marden_multivariate_2015} which will be implemented in Scala in section 3.5. For now, note that $\boldsymbol{\Sigma}$ is the multivariate equivalent for V(x).     
\\
\\
