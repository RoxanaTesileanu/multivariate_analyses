...
Because there is an infinite number of possible Normal distributions which might be used, calculating probability values from all these curves would imply too much   
