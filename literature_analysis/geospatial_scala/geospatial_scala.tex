...
In this section I will use points looked up on Google Maps (so, using WGS84/Pseudo-Mercator) to create OGR geometries like Points, Lines or Polygons. Then I will create a vector layer to store these geometries. 
