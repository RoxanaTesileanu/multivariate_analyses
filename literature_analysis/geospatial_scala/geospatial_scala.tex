...
\item the \textbf{b} column vector with the constants of the linear system, i.e. the right hand side; during the dgesv routine, \textbf{b} gets overritten and will contain the solution of the system,
