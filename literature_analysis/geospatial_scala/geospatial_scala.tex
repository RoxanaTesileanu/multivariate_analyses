...
This work uses the GDAL open source library \cite{osgeo_gdal_nodate} developed at the Open Source Geospatial Foundation (OSGeo) \href{www.osgeo.org}{www.osgeo.org}. GDAL was written in C and C++ and has bindings for several languages (Java, Perl and Python). \\     
