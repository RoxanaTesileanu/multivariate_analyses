...
\\
The OGR package of GDAL contains the classes used for geoprocessing vector data. The OGR Java API (\href{http://gdal.org/java/}{http://gdal.org/java/}) lists them all. Among them there are the classes: Driver, DataSource, Layer, Geometry and Feature.    
