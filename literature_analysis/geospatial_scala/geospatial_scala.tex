...
For a bivariate Normal distribution, with \textbf{m\textsubscript{i}} expressed as $\mathbf{m\textsubscript{i}}= (n_i1, n_i2)$, the mean is expressed as a nx1 matrix $\boldsymbol{\mu}=[\mu_1, \mu_2]'$ \footnote{The nx1 matrix has the form of a column vector.}
