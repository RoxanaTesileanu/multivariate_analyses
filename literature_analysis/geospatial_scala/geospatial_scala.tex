...
Thus the data matrix \textit{A} contains m rows, where $m=1,..,i$, and n columns, where $n=1,..,j$.
 Each entry in \textit{A}, $a_ij$, represents the recorded value for the ith observation on the $j^{th}$ recorded variable.
