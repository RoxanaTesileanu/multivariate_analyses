...
\\
\\
In order to import LAPACK in Scala, you need to add the package containing it to the build.sbt file of the Scala project ("com.github.fommil.netlib" \% "core" \% "1.1.2" \cite{}).  
