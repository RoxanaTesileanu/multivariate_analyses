...
Because the probability values of the z distribution can only be found iteratively through intensive computation, these values are often taken from already existing tables.   
