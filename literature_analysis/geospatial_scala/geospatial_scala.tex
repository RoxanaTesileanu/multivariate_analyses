...
The individual entries $a_{ij}$ of the data matrix \textit{A}, contain the values of the recorded variables. These values may represent continuous, discrete or categorical variables \cite{carroll_mathematical_1997}.  
