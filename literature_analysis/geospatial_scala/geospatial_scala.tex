...
The individual entries $a_{ij}$ of the data matrix \textit{A}, contain the values of the recorded variables.
 ...
 If there is one response variable and more predictor variables, we have either multiple linear regression (if the response variable as well as the predictor variables are continuous) or multifactor ANOVA (if the response variable is continuous and the predictor variables are categorical).
