...
Discrete probability models are best vizualized using a histogram. The bars of the histogram have the same width and their heights are determined by the probabilities of the possible values (i.e. class 1 to class 8). See \ref{fig: discrete prob}. 
\begin{figure} [H]
...
\end{cases} 
\end{equation}
See \ref{fig: unif distr} for an example of a uniform probability density function. 
\begin{figure} [H]
