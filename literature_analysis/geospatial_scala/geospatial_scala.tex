...
In this work I use the Linear Algebra Package (LAPACK) provided by the University of Tennessee, Berkeley University of California and Denver University of Colorado \cite{icl_lapack_2017}. LAPACK is a written in Fortran 90 and is a freely-available software package (see \href{http://www.netlib.org/lapack/}{http://www.netlib.org/lapack/}. 
\\
\\
...
\\
\\
You can check the routines provided by LAPLACK using the TAB-autocompletion on the lapack instance. Among these, the driver routines for solving systems of linear equations for a general matrix (xGESV) or for linear least squares problems (xGELS for QR factorization, or xGELSS for SVD factorization) .
