...
\\
\\
Using the above code a linear system of type $Ax=b$ was solved using LAPACK dgesv, and, at the same time we made use of Scala types and also the output was a Scala type. 
