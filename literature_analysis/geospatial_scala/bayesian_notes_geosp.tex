...
\end{equation*}  
where $p(y)= \int p(\theta) p(y| \theta) \mathrm{d} \theta$ (for $\theta$ continuous), and $1/p(y)$ represents the constant of proportionality which can be formally written as (Jackman 2009): 
\begin {equation*}
