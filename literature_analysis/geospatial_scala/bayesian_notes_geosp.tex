...
From Jackman 2009:\\
\textbf{Conjugacy of Beta prior, Binomial data: Given a Binomial likelihood over r successes in n Bernoulli trials, each independent conditional on an unknown success parameter $\theta \in [0,1]$  }
