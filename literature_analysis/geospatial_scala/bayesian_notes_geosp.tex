...
In the extreme case of an uninformative prior, the only information about the parameter is the information in the data, and the posterior has the same shape as the likelihood function. When prior information is available, the posterior incorporates it rationally, in the sense of being consistent with the laws of probability via Bayes Theorem.     
