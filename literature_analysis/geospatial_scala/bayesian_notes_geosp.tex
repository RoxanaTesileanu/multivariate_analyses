...
BAYESIAN INFERENCE is the process of fitting a probability model to a set of data and SUMMARIZING THE RESULT BY A PROBABILITY DISTRIBUTION ON: \begin{enumerate}
\item THE PARAMETERS OF THE MODEL and on
\item THE UNOBSERVED QUANTITIES SUCH AS PREDICTIONS FOR NEW OBSERVATIONS.
\end{enumerate} 
Steps of Bayesian Data Analysis:\begin{enumerate}
