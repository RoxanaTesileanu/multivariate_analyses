...
For high residuals we choose a higher k number, and for low residuals we choose a lower k number. This could be a helpful investigation pipeline for diffusion processes. 
