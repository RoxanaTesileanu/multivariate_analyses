...
For high residuals we choose a higher k number, and for low residuals we choose a lower k number. Diffusion. This idea certainly requires a further investigation, but should have a high practical relevance for environmental data analysis.
