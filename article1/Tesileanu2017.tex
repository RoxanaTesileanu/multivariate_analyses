...
For high residuals we choose a higher k number, and for low residuals we choose a lower k number. This approach could represent a helpful investigation pipeline for diffusion processes and certainly requires further investigation, possibly requiring the use of alternative dissimilarity measures indentifying the correct direction   but should have a high practical relevance for environmental data analysis.
