...
The present paper introduces the Scala functions used to run the kNN algorithm and then it delineates a possible use of the classifier within a real-world classification pipeline for reducing error.    
