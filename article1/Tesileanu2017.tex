...
For high residuals we choose a higher k number, and for low residuals we choose a lower k number. This approach could represent a helpful investigation pipeline for diffusion processes. 
This idea certainly requires further investigation, but should have a high practical relevance for environmental data analysis.
